...
template_info = """
    ##Instruction##:-
        ...
        **Your task is to generate response in an age specific manner, with the information provided in a story telling format to engaeg users**
...
def generate_info(data):
    ...
    """
    info_query += """{
   "name_of_planet": "TOI 123 b",
   "type": "Neptune",
   "distance": "25 light-years",
   "star": "TOI 123",
   "info": "This is about TOI 123 b ....."
}
*Above is the json for your reference, Take this as an example and reference to generate the response in json format*

###All the information should be fetched from the provided context like the type of the planet and star it revolves, only in the case when context in not enough you can use your own information and enhancements to generate information in a story telling format.###
"""
    gemini_embeddings, model =helper.models()
    retriever,retriever1,retriever2,retriever3,retriever4,retriever5,retriever6,retriever7,retriever8,retriever9 = quiz_info_helper.context(gemini_embeddings)
    chain = (
    ...
    result
    print(result)
    url_eye = quiz_info_helper.planrt_nasa_url(planet)
    ...
    return {"result":result, "image_url":random_image_url, "planet_url":url_eye},200
